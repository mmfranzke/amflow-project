...
Export[
  FileNameJoin[{$ResultsDirectory, "outer_eq29_plus_result.wl"}],
  result
];

Export[
  FileNameJoin[{$ResultsDirectory, "outer_eq29_plus_result.txt"}],
