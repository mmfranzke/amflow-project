...
\begin{equation}
  ...
  M_k^2=\frac{81}{100}.
\end{equation}
This differs from the older Euclidean Python-check point. The larger value of
\(M_l^2\) makes both \(\Delta_0\) and \(\Delta_1\) positive at \(p^2=0\), so
the first AMFlow comparison is not mixed with a branch-cut phase test.
