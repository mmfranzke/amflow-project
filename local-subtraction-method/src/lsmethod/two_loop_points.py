...
POINTS = {
    ...
    "four_mass_offshell_branch_safe_A": TwoLoopPoint(
    ...
    "four_mass_offshell_branch_safe_B": TwoLoopPoint(
        name="four_mass_offshell_branch_safe_B",
        p_plus=Fraction(1),
        p_minus=Fraction(1, 5),
        p_perp2=Fraction(0),
        x=Fraction(1, 5),
        y=Fraction(3, 10),
        ml2=Fraction(1),
    ...
    "four_mass_offshell_branch_safe_C": TwoLoopPoint(
